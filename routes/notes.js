...
[
    ...
    body('description',"Enter a description atleast 5 characters").isLength({min:5})
],
...
//ROUTE 3: Update an existing Note using: PUT "/api/notes/updatenot:id". Login required
